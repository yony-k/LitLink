...
public record OAuth2UserDTO(
  ...
  public static OAuth2UserDTO of(String registrationId, String userNameAttributeName, Map<String, Object> oAuth2UserAttributes) {
  ...
  // 카카오일 경우
  private static OAuth2UserDTO ofKakao(String userNameAttributeName, Map<String, Object> oAuth2UserAttributes) {
